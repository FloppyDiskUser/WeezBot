...
namespace WeezBot.Model
{
    ...
    public class ObservableSettings : DependencyObject
    {
        ...
        private void SaveCurrentCoords(string botName)
        {
            var coordsPath = Path.Combine(Directory.GetCurrentDirectory(), "Config", botName, "LastPos.ini");
        ...
        internal GlobalSettings GetGlobalSettingsObject(string botName)
        {
